...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "projects_services" ALTER COLUMN "_parent_id" SET DATA TYPE uuid;
  ALTER TABLE "projects_technologies" ALTER COLUMN "_parent_id" SET DATA TYPE uuid;
  ALTER TABLE "projects" ALTER COLUMN "id" SET DATA TYPE uuid;
  ALTER TABLE "projects" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();
  ALTER TABLE "projects" ALTER COLUMN "featured_image_id" SET DATA TYPE uuid;
  ALTER TABLE "services" ALTER COLUMN "id" SET DATA TYPE uuid;
  ALTER TABLE "services" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();
  ALTER TABLE "services" ALTER COLUMN "featured_image_id" SET DATA TYPE uuid;
  ALTER TABLE "media" ALTER COLUMN "id" SET DATA TYPE uuid;
  ALTER TABLE "media" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();
  ALTER TABLE "testimonials" ALTER COLUMN "id" SET DATA TYPE uuid;
  ...
  ALTER TABLE "payload_locked_documents_rels" ALTER COLUMN "projects_id" SET DATA TYPE uuid;
  ALTER TABLE "payload_locked_documents_rels" ALTER COLUMN "services_id" SET DATA TYPE uuid;
  ALTER TABLE "payload_locked_documents_rels" ALTER COLUMN "media_id" SET DATA TYPE uuid;
  ALTER TABLE "payload_locked_documents_rels" ALTER COLUMN "testimonials_id" SET DATA TYPE uuid;
